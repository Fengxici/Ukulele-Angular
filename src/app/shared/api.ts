export enum Api {
  ...
  ForgotPasswordApi = 'api/support-service/user/forgot',
  ResetPassordApi = 'api/support-service/reset',
  KaptchaApi = 'api/supply-service/kaptcha/render?_allow_anonymous=true',
