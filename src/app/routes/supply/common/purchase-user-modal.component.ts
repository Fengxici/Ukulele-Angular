...
@Component({
  selector: 'app-firm-purchase-user-modal',
  template: `<nz-card>
...
export class FirmPurchaseUserModalComponent implements OnInit {
  constructor(
  ...
  query(event: any) {
    ...
    this.http
      .get(Api.BaseSupplyUserApi + '/purchase/page/' + current + '/' + size, this.params)
      .subscribe((res: any) => {
