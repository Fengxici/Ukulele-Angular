...
import { STColumn, STComponent, STChange, STColumnBadge } from '@delon/abc';
...
@Component({
  selector: 'app-supply-abnormal',
  templateUrl: './abnormal.component.html',
})
export class AbnormalComponent extends BaseAbilityComponent
  ...
  query(event: any) {
    ...
    this.http
      .get(Api.BaseSupplyPurchaseApi + 'detail/abnormal/' + firmInfo.id)
      .subscribe((res: any) => {
